      ...
      <div className="mx-auto py-[20px] px-[20px] lg:px-[40px] xl:px-[80px]">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:block border-[1px] border-[#D9D9D9] rounded-[10px] px-[30px] xl:px-[48px] py-[10px] bg-[#F9F9F999]">
            <div className="flex gap-[24px] xl:gap-[48px]">
              {navItems.map((item) => (
                <a
                  key={item.label}
                  href={item.href}
          ...
          <div className="flex gap-4 items-center">
            ...
            <div className="hidden md:block">
              <a href="/account-type">
                <button
                  type="submit"
                  className="h-12 w-20 rounded-lg bg-[#FFC300] text-[#15141F] text-sm font-semibold"
                >
                  Sign up
                </button>
              </a>
        ...
        <div className="fixed inset-0 bg-white z-50 overflow-y-auto lg:hidden">
          ...
          <div className="flex p-4 gap-4">
            <a href="/login" className="flex-1">
              <button
                type="submit"
                className="border border-primary w-full h-12 rounded-lg bg-white text-primary text-sm font-semibold"
              >
                Log in
              </button>
            </a>
            <a href="/account-type" className="flex-1">
              <button
                type="submit"
                className="border w-full h-12 rounded-lg bg-primary text-white text-sm font-semibold"
              >
                Sign up
              </button>
            </a>
          ...
          <div className="px-4 py-4 border-t">
            ...
            <div className="py-2 flex items-start gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 text-[#FFC300] mt-1"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
