...
const HelpCenter = () => {
      ...
      case "pay-order":
        return (
          <div>
            ...
            <p>
              Information about payment methods and processes would go here.
            </p>
          </div>
        );
      case "track-order":
      ...
      case "return-request":
        return (
          <div>
            ...
            <p>
              Information about return policies and procedures would go here.
            </p>
          </div>
        );
      case "rate-product":
  ...
  const getIcon = (iconName: string) => {
    return (
      ...
      >
        <path
          d="M4.5 2.125H1.375V17.125H12.625V2.125H9.5M3.25 13.375H10.75M4.5 3.375H9.5L10.125 0.875H3.875L4.5 3.375ZM4.5 11.5L6.375 10.875L10.125 7.125L8.875 5.875L5.125 9.625L4.5 11.5Z"
      ...
      <div className="min-h-screen bg-gray-100">
        ...
        <div className="mx-auto py-6 px-4 md:px-32 md:py-16">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div
              className={`w-full md:w-64 flex-shrink-0 ${showContentOnMobile ? "hidden md:block" : "block"}`}
            >
              <div className="space-y-1">
                {sidebarItems.map((item) => (
                  <button
                    key={item.id}
                    className={`flex items-center px-[30px] py-[30px] text-[16px] font-semibold w-full text-left rounded-[8px] ${
                      activeItem === item.id
            ...
            <div
              className={`flex-1 ${showContentOnMobile ? "block" : "hidden md:block"}`}
            >
