...
const AccountInformation = () => {
    ...
    const renderContent = () => {
        switch (activeItem) {
            ...
            case 'orders':
                return <div className="p-6 bg-white rounded-lg border border-gray-200"><h2 className="text-xl font-semibold">Orders</h2><p className="text-gray-500 mt-2">Your orders will appear here.</p></div>;
            case 'saved':
                return <div className="p-6 bg-white rounded-lg border border-gray-200"><h2 className="text-xl font-semibold">Saved Items</h2><p className="text-gray-500 mt-2">Your saved items will appear here.</p></div>;
            case 'track':
                return <div className="p-6 bg-white rounded-lg border border-gray-200"><h2 className="text-xl font-semibold">Track Order</h2><p className="text-gray-500 mt-2">Your order tracking information will appear here.</p></div>;
            case 'messages':
                return <div className="p-6 bg-white rounded-lg border border-gray-200"><h2 className="text-xl font-semibold">Messages</h2><p className="text-gray-500 mt-2">Your messages will appear here.</p></div>;
            case 'security':
                return <div className="p-6 bg-white rounded-lg border border-gray-200"><h2 className="text-xl font-semibold">Security</h2><p className="text-gray-500 mt-2">Your security settings will appear here.</p></div>;
            case 'logout':
                return <div className="p-6 bg-white rounded-lg border border-gray-200"><h2 className="text-xl font-semibold">Log Out</h2><p className="text-gray-500 mt-2">You will be logged out.</p></div>;
            default:
                return null;
        }
    };
    ...
    return (
        <div className="bg-[#F5F5F5] mx-auto px-4 md:px-16 py-6">
            ...
            <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className={`w-full md:w-1/3 lg:w-1/4 ${activeItem ? 'hidden md:block' : 'block'}`}>
                ...
                <div className={`w-full md:w-2/3 lg:w-3/4 ${!activeItem && window.innerWidth < 768 ? 'hidden' : 'block'}`}>
                    {renderContent()}
                </div>
            </div>
        </div>
