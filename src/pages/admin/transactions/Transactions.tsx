      ...
      <div className="p-6">
        ...
        <section className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-6">
            <div>
              <h2 className="text-sm font-medium text-gray-700 mb-2">User Type</h2>
            ...
            <div>
              <h2 className="text-sm font-medium text-gray-700 mb-2">Store</h2>
              <div className="relative w-[150px] h-[40px]">
                <select className="w-full h-full bg-white px-3 pr-8 appearance-none rounded-[6px] text-sm border border-gray-300 text-gray-700">
            ...
            <div>
              <h2 className="text-sm font-medium text-gray-700 mb-2">Amount</h2>
              <div className="relative w-[150px] h-[40px]">
                <select className="w-full h-full bg-white px-3 pr-8 appearance-none rounded-[6px] text-sm border border-gray-300 text-gray-700">
            ...
            <tbody>
              {transactions.map((transaction) => (
                <tr key={transaction.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="p-4 text-sm text-gray-700">{transaction.transactionId}</td>
                  <td className="p-4 text-sm font-medium text-gray-900">{transaction.userName}</td>
                  <td className="p-4 text-sm text-gray-700">{transaction.userType}</td>
                  <td className="p-4 text-sm text-gray-700">{transaction.orderId}</td>
                  <td className="p-4 text-sm font-medium text-gray-900">{transaction.paymentAmount}</td>
                  <td className="p-4">
                    <span
                  ...
                  <td className="p-4 text-sm text-gray-700">{transaction.paymentMethod}</td>
