...
export default function TestimonialCarousel() {
    ...
    return (
        <div className="relative w-full bg-cover bg-center bg-no-repeat py-12 text-white overflow-hidden font-roboto" style={{ backgroundImage: `url(${Testimonial})` }}>
            <h2 className="text-[20px] md:text-[24px] font-semibold px-[30px] flex items-center text-white mb-6 font-roboto">
            ...
            <div className="relative flex items-center justify-center px-4">
                ...
                >
                    {testimonials.map((testimonial, index) => (
                        ...
                        >
                            <img src="/apostrophe.png" alt="apostrophe" className="w-[35px] h-[30px]" />
                            <p className="mt-4 text-[12px] md:text-[14px]">{testimonial.text}</p>
