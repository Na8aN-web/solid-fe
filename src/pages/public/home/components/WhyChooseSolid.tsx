            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="border-[2px] border-primary rounded-lg bg-[#00336626] p-6">
                    ...
                    <p className="text-[12px] text-primary mb-4">
                        Access spare parts for all types of vehicles, including cars, trucks, and tractors.
                    </p>
                    <button className="bg-white border border-gray-200 italic text-primary py-2 px-4 rounded-md text-sm font-medium inline-flex items-center">
                        Start Shopping
                ...
                <div className="border-[2px] border-primary rounded-lg bg-[#00336626] p-6">
                    ...
                    <h3 className="text-primary font-bold mb-2">Direct Manufacturer Access</h3>
                    <p className="text-[12px] text-primary mb-4">
